...
<table width="856" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<font color="#ffffff"><b>(주)종우갓</b> </font>&nbsp;&nbsp;대표이사 : 종우갓&nbsp;&nbsp;&nbsp;
		사업자등록번호 : 220-88-77149&nbsp;&nbsp;&nbsp;개인정보담당자 : 임종우<br /> 서울특별시 강남&nbsp;&nbsp;<font color="#ffffff">
	...
	<tr>
		...
		<td valign="top"></td>
		<td valign="top"
			style="text-align: left; color: rgb(153, 153, 153); line-height: 1.6em; 
			font-family: 나눔고딕; font-size: 12px; text-decoration: none; padding-bottom: 30px; padding-top: 20px;">
			Copyright ⓒ God Korea. All Rights Reserved.</td>
	</tr>
</table>
